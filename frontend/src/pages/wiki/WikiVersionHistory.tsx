    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="flex gap-6">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {hasPermission("wiki:update") && page && v.version_number !== page.version && (
                      <button
                        ...
                        className="p-1 rounded hover:bg-[var(--color-surface-2)] text-[var(--color-text-muted)] disabled:opacity-50"
          ...
          {/* Preview panel */}
          {previewVersion && (
            <div className="flex-1 border border-[var(--color-border)] rounded-lg">

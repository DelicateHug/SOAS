"""Form definition (template) model."""
...
class FormDefinition(Base):
    ...
    submissions: Mapped[list["FormSubmission"]] = relationship(  # noqa: F821
        back_populates="form_definition", cascade="all, delete-orphan"
    )

    __table_args__ = (
        Index("idx_form_definitions_name", "name"),
        Index("idx_form_definitions_active", "is_active"),
    )
